...
enum RegisterMobileOTPState { SHOW_REGISTER, SHOW_OTP }
...
class _RegisterMobileState extends State<RegisterMobile> {
  RegisterMobileOTPState currentState = RegisterMobileOTPState.SHOW_REGISTER;
  ...
  Widget build(BuildContext context) {
    return currentState == RegisterMobileOTPState.SHOW_REGISTER
        ? getRegisterMobileScreen(context)
  ...
  getRegisterMobileScreen(BuildContext context) {
    return Scaffold(
      body: Center(
                              ...
                              await _auth.verifyPhoneNumber(
                                  ...
                                  codeSent: (verID, resend) {
                                    ...
                                    setState(() {
                                      ...
                                      currentState = RegisterMobileOTPState.SHOW_OTP;
                                    });
                                  },
