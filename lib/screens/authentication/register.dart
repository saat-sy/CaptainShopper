...
enum RegisterOTPState { SHOW_REGISTER, SHOW_OTP }
...
class _RegisterState extends State<Register> {
  RegisterOTPState currentState = RegisterOTPState.SHOW_REGISTER;
  ...
  Widget build(BuildContext context) {
    return currentState == RegisterOTPState.SHOW_REGISTER
  ...
  getRegisterScreen(BuildContext context) {
    return Scaffold(
      body: Center(
                              ...
                              await _auth.verifyPhoneNumber(
                                  ...
                                  codeSent: (verID, resend) {
                                    ...
                                    setState(() {
                                      ...
                                      currentState = RegisterOTPState.SHOW_OTP;
                                    });
                                  },
